...
<head>
    <link rel="stylesheet" href="rankingEdits.css" />
    <meta charset="UTF-8">
    ...
    <div class="right-column">
        ...
        <div class="table-container">
            <table class="table table-dark table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td><img src="https://www.mancity.com/meta/media/233jlh2j/microsoftteams-image-127.png" alt="Logo" id="teamsLogo"></td>
                            <td>Erling Haaland</td>
                            <td><img src="https://upload.wikimedia.org/wikipedia/en/thumb/e/eb/Manchester_City_FC_badge.svg/1200px-Manchester_City_FC_badge.svg.png" alt="Logo" id="teamLogo">&nbsp;Manchester City</td>
                            <td>&nbsp;&nbsp;&nbsp;26</td>
                        </tr>
                        <tr>
                            <td><img src="https://cdne-totv8-prod-westeurope.azureedge.net/media/tkgczptd/firstteam_profiles_202223_harrykane.png?anchor=center&mode=crop&quality=100&width=750" alt="Logo" id="teamsLogo"></td>
                            <td>Harry Kane</td>
                            <td><img src="https://upload.wikimedia.org/wikipedia/en/thumb/b/b4/Tottenham_Hotspur.svg/1200px-Tottenham_Hotspur.svg.png" alt="Logo" id="teamLogo">&nbsp;Tottenham Hotspurs</td>
                            <td>&nbsp;&nbsp;&nbsp;21</td>
                        </tr>
                        <tr>
                             <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p144485.png" alt="Logo" id="teamsLogo"></td>
                            <td>Ivan Toney</td>
                            <td><img src="https://upload.wikimedia.org/wikipedia/en/thumb/2/2a/Brentford_FC_crest.svg/1200px-Brentford_FC_crest.svg.png" alt="Logo" id="teamLogo">&nbsp;Brentford</td>
                            <td>&nbsp;&nbsp;&nbsp;17</td>
                        </tr>
                        <tr>
                             <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p444145.png" alt="Logo" id="teamsLogo"></td>
                            <td>Gabriel Martinelli</td>
                            <td><img src="https://upload.wikimedia.org/wikipedia/en/5/53/Arsenal_FC.svg" alt="Logo" id="teamLogo">&nbsp;Arsenal</td>
                            <td>&nbsp;&nbsp;&nbsp;13</td>
                        </tr>
                        <tr>
                             <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p223340.png" alt="Logo" id="teamsLogo"></td>
                            <td>Bukayo Saka</td>
                            <td><img src="https://upload.wikimedia.org/wikipedia/en/5/53/Arsenal_FC.svg" alt="Logo" id="teamLogo">&nbsp;Arsenal</td>
                            <td>&nbsp;&nbsp;&nbsp;12</td>
                        </tr>
                        <tr>
                             <td><img src="https://i.pinimg.com/originals/de/ed/60/deed6064026ecc9dfa396b78c3ee521c.png" alt="Logo" id="teamsLogo"></td>
                            <td>Mohamed Salah</td>
                            <td><img src="https://upload.wikimedia.org/wikipedia/hif/b/bd/Liverpool_FC.png" alt="Logo" id="teamLogo">&nbsp;Liverpool</td>
                            <td>&nbsp;&nbsp;&nbsp;12</td>
                        </tr>
                        <tr>
                             <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p179018.png" alt="Logo" id="teamsLogo"></td>
                            <td>Miguel Almiron</td>
                            <td><img src="https://upload.wikimedia.org/wikipedia/hif/2/25/Newcastle_United_Logo.png" alt="Logo" id="teamLogo">Newcastle United</td>
                            <td>&nbsp;&nbsp;&nbsp;11</td>
                        </tr>
