...
<body id="wholescreen">
    ...
    <div class="right-column">
        ...
        <center><p id ="latestHeading">Most Assists</p></center>
        <div class="table-container">
            <table class="table table-dark table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td><img src="https://www.mancity.com/meta/media/4jeo4c53/kevin-de-bruyne.png" alt="Logo" id="teamsLogo"></td>
                        ...
                        <tr>
                             <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p116216.png" alt="Logo" id="teamsLogo"></td>
                            <td>Leandro Trossard</td>
                            <td><img src="https://upload.wikimedia.org/wikipedia/en/5/53/Arsenal_FC.svg" alt="Logo" id="teamLogo">&nbsp;Arsenal</td>
                            <td>&nbsp;&nbsp;&nbsp;9</td>
                        </tr>
                        <tr>
                             <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p80607.png" alt="Logo" id="teamsLogo"></td>
                            <td>Christian Eriksen</td>
                            <td><img src="http://as01.epimg.net/img/comunes/fotos/fichas/equipos/large/67.png" alt="Logo" id="teamLogo">&nbsp;Manchester United</td>
                            <td>&nbsp;&nbsp;&nbsp;7</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p184029.png" alt="Logo" id="teamsLogo"></td>
                            <td>Martin Ødegaard</td>
                            <td><img src="https://upload.wikimedia.org/wikipedia/en/5/53/Arsenal_FC.svg" alt="Logo" id="teamLogo">&nbsp;Arsenal</td>
                            <td>&nbsp;&nbsp;&nbsp;7</td>
                        </tr>
                        <tr>
                             <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p141746.png" alt="Logo" id="teamsLogo"></td>
