<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RedCard.aspx.cs" Inherits="FastFoot.RedCard" %>
...
<body id="wholescreen">
    ...
    <div class="right-column">
        ...
        <center><p id ="THeading">Most Red Cards</p></center>
        <div class="table-container">
            <table class="table table-dark table-striped">
                    ...
                    <tbody>
                        <tr>
                            <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p61256.png" alt="Logo" id="teamsLogo"></td>
                            <td>Casemiro</td>
                            <td><img src="http://as01.epimg.net/img/comunes/fotos/fichas/equipos/large/67.png" alt="Logo" id="teamLogo">&nbsp;Manchester United</td>
                            <td>&nbsp;&nbsp;&nbsp;2</td>
                        </tr>
                        <tr>
                             <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p200785.png" alt="Logo" id="teamsLogo"></td>
                            <td>Tyler Adams</td>
                            <td><img src="https://upload.wikimedia.org/wikipedia/en/thumb/5/54/Leeds_United_F.C._logo.svg/1200px-Leeds_United_F.C._logo.svg.png" alt="Logo" id="teamLogo">&nbsp;Leeds United</td>
                            <td>&nbsp;&nbsp;&nbsp;1</td>
                        </tr>
                        <tr>
                             <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p432160.png" alt="Logo" id="teamsLogo"></td>
                        ...
                        <tr>
                             <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p200402.png" alt="Logo" id="teamsLogo"></td>
                            <td>Nelson Semedo</td>
                            <td><img src="https://logodownload.org/wp-content/uploads/2019/04/wolverhampton-logo-escudo.png" alt="Logo" id="teamLogo">&nbsp;Wolverhampton Wanderers</td>
                            <td>&nbsp;&nbsp;&nbsp;1</td>
                        </tr>
                        <tr>
                             <td><img src="https://resources.premierleague.com/premierleague/photos/players/250x250/p114128.png" alt="Logo" id="teamsLogo"></td>
                            <td>Jonny</td>
                            <td><img src="https://logodownload.org/wp-content/uploads/2019/04/wolverhampton-logo-escudo.png" alt="Logo" id="teamLogo">&nbsp;Wolverhampton Wanderers</td>
                            <td>&nbsp;&nbsp;&nbsp;1</td>
                        </tr>
